...
var Sentry = function(n) {
	...
	}(e || (e = {})), (i = n.Severity || (n.Severity = {}))
	.Fatal = "fatal", i.Error = "error", i.Warning = "warning", i.Log = "log", i.Info = "info", i.Debug = "debug", i.Critical = "critical",
		function(n) {
		...
		}(n.Severity || (n.Severity = {})), (o = n.Status || (n.Status = {}))
		.Unknown = "unknown", o.Skipped = "skipped", o.Success = "success", o.RateLimit = "rate_limit", o.Invalid = "invalid", o.Failed = "failed",
		function(n) {
	...
	function A(n, t, r, e) {
		if (void 0 === r && (r = 1 / 0), void 0 === e && (e = new R), 0 === r) return function(n) {
	...
	var B = function() {
			function n(n) {
				var t = this;
				this.l = M.PENDING, this.v = [], this.p = function(n) {
					t.m(n, M.RESOLVED)
				}, this.g = function(n) {
					t.m(n, M.REJECTED)
				}, this.m = function(n, r) {
					t.l === M.PENDING && (y(n) ? n.then(t.p, t.g) : (t.j = n, t.l = r, t._()))
				}, this._ = function() {
					t.l !== M.PENDING && (t.l === M.REJECTED ? t.v.forEach(function(n) {
		...
		X = function() {
			function n(n, t, r, e) {
				void 0 === n && (n = g()), void 0 === t && (t = g()
					.substring(16)), this.O = n, this.k = t, this.T = r, this.R = e
			}
		...
		G = function() {
			function n() {
				this.D = !1, this.I = [], this.C = [], this.N = [], this.A = {}, this.L = {}, this.M = {}, this.U = {}
			}
			return n.prototype.addScopeListener = function(n) {
				...
				var i = this;
				return void 0 === e && (e = 0), new B(function(o, c) {
					var s = n[e];
					if (null === t || "function" != typeof s) o(t);
					else {
						var a = s(u({}, t), r);
						y(a) ? a.then(function(t) {
								return i.P(n, t, r, e + 1)
									.then(o)
							})
							.catch(c) : i.P(n, a, r, e + 1)
							.then(o)
							.catch(c)
					}
				})
			}, n.prototype.setUser = function(n) {
				return this.A = L(n), this.F(), this
			}, n.prototype.setTags = function(n) {
				return this.L = u({}, this.L, L(n)), this.F(), this
			}, n.prototype.setTag = function(n, t) {
				var r;
				return this.L = u({}, this.L, ((r = {})[n] = L(t), r)), this.F(), this
			}, n.prototype.setExtras = function(n) {
				return this.M = u({}, this.M, L(n)), this.F(), this
			}, n.prototype.setExtra = function(n, t) {
				var r;
				return this.M = u({}, this.M, ((r = {})[n] = L(t), r)), this.F(), this
			}, n.prototype.setFingerprint = function(n) {
				return this.$ = L(n), this.F(), this
			}, n.prototype.setLevel = function(n) {
				return this.q = L(n), this.F(), this
			}, n.prototype.setTransaction = function(n) {
				return this.H = n, this.F(), this
			}, n.prototype.setContext = function(n, t) {
				return this.U[n] = t ? L(t) : void 0, this.F(), this
				...
				return Object.assign(r, t, {
					I: []
				}), t && (r.N = s(t.N), r.L = u({}, t.L), r.M = u({}, t.M), r.U = u({}, t.U), r.A = t.A, r.q = t.q, r.W = t.W, r.H = t.H, r.$ = t.$, r.C = s(t.C)), r
			}, n.prototype.clear = function() {
				return this.N = [], this.L = {}, this.M = {}, this.A = {}, this.U = {}, this.q = void 0, this.H = void 0, this.$ = void 0, this.W = void 0, this.F(), this
				...
				return this.N = void 0 !== t && t >= 0 ? s(this.N, [L(e)])
					.slice(-t) : s(this.N, [L(e)]), this.F(), this
			}, n.prototype.clearBreadcrumbs = function() {
				return this.N = [], this.F(), this
				...
				return this.M && Object.keys(this.M)
					.length && (n.extra = u({}, this.M, n.extra)), this.L && Object.keys(this.L)
					.length && (n.tags = u({}, this.L, n.tags)), this.A && Object.keys(this.A)
					.length && (n.user = u({}, this.A, n.user)), this.U && Object.keys(this.U)
					.length && (n.contexts = u({}, this.U, n.contexts)), this.q && (n.level = this.q), this.H && (n.transaction = this.H), this.W && (n.contexts = n.contexts || {}, n.contexts.trace = this.W), this.B(n), n.breadcrumbs = s(n.breadcrumbs || [], this.N), n.breadcrumbs = n.breadcrumbs.length > 0 ? n.breadcrumbs : void 0, this.P(s(z(), this.C), n, t)
			}, n
		}();
	...
	var K = 3,
		Z = function() {
			function n(n, t, r) {
				void 0 === t && (t = new G), void 0 === r && (r = K), this.J = r, this.X = [], this.X.push({
					client: n,
					scope: t
				})
			}
	...
	function nn() {
		var n, t, r = Q();
		tn(r) && !rn(r)
			.isOlderThan(K) || en(r, new Z);
		try {
			var e = (n = module, t = "domain", n.require(t))
				.active;
			if (!e) return rn(r);
			if (!tn(e) || rn(e)
				.isOlderThan(K)) {
				var i = rn(r)
					.getStackTop();
				en(e, new Z(i.client, G.clone(i.scope)))
			}
			return rn(e)
		} catch (n) {
			return rn(r)
	...
	function rn(n) {
		return n && n.__SENTRY__ && n.__SENTRY__.hub ? n.__SENTRY__.hub : (n.__SENTRY__ = n.__SENTRY__ || {}, n.__SENTRY__.hub = new Z, n.__SENTRY__.hub)
	}
	...
	var cn = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+))?@)([\w\.-]+)(?::(\d+))?\/(.+)/,
		sn = function() {
			...
			return n.prototype.toString = function(n) {
				...
				var r = c(t.slice(1), 6),
					...
					v = r[5],
					d = v.split("/");
				d.length > 1 && (l = d.slice(0, -1)
					.join("/"), v = d.pop()), Object.assign(this, {
					host: s,
					pass: u,
					path: l,
					projectId: v,
		...
		an = function() {
			...
			return n.prototype.getDsn = function() {
				...
				return this.getStoreEndpoint() + "?" + (n = t, Object.keys(n)
					.map(function(t) {
				...
				return e.push("sentry_timestamp=" + (new Date)
					.getTime()), e.push("sentry_client=" + n + "/" + t), e.push("sentry_key=" + r.user), r.pass && e.push("sentry_secret=" + r.pass), {
				...
				for (var i in e.push("dsn=" + t.toString()), n)
					if ("user" === i) {
						if (!n.user) continue;
						n.user.name && e.push("name=" + encodeURIComponent(n.user.name)), n.user.email && e.push("emails=" + encodeURIComponent(n.user.email))
	...
	var ln, vn = function() {
			function n(n, t) {
				this.rn = !1, this.en = new n(t), this.in = t, t.dsn && (this.on = new sn(t.dsn)), this.un = hn(this.in)
			}
			return n.prototype.captureException = function(n, t, r) {
				var e = this,
					i = t && t.event_id;
				return this.rn = !0, this.cn()
				...
				var i = this,
					o = r && r.event_id;
				return this.rn = !0, (p(n) ? this.cn()
						.eventFromMessage("" + n, t, r) : this.cn()
				...
				var e = this,
					i = t && t.event_id;
				return this.rn = !0, this.sn(n, t, r)
					.then(function(n) {
						i = n && n.event_id, e.rn = !1
					})
					.catch(function(n) {
				...
				return this.an(n)
					.then(function(r) {
						return clearInterval(r.interval), t.cn()
							.getTransport()
							.close(n)
							.then(function(n) {
								return r.ready && n
				...
				return !1 !== this.getOptions()
					.enabled && void 0 !== this.on
				...
				var e = this.getOptions(),
					...
					a = void 0 === s ? 250 : s,
					f = u({}, n);
				void 0 === f.environment && void 0 !== i && (f.environment = i), void 0 === f.release && void 0 !== o && (f.release = o), void 0 === f.dist && void 0 !== c && (f.dist = c), f.message && (f.message = F(f.message, a));
				...
				var e = this,
					...
					o = i.beforeSend,
					u = i.sampleRate;
				return this.fn() ? "number" == typeof u && Math.random() > u ? B.reject("This event has been sampled, will not send event.") : new B(function(i, u) {
					e.hn(n, r, t)
						.then(function(n) {
							if (null !== n) {
								var r = n;
								try {
									if (t && t.data && !0 === t.data.__sentry__ || !o) return e.cn()
										.sendEvent(r), void i(r);
									var c = o(n, t);
				...
				n.then(function(n) {
						null !== n ? (e.cn()
							.sendEvent(n), t(n)) : r("`beforeSend` returned `null`, will not send event.")
					})
					.catch(function(n) {
		...
		pn = function() {
			function n(n) {
				this.in = n, this.in.dsn || T.warn("No DSN provided, backend will not do anything."), this.dn = this.pn()
			}
	...
	var mn = function() {
			...
			return n.prototype.setupOnce = function() {
				ln = Function.prototype.toString, Function.prototype.toString = function() {
					for (var n = [], t = 0; t < arguments.length; t++) n[t] = arguments[t];
		...
		bn = function() {
			...
			return n.prototype.setupOnce = function() {
				...
				return void 0 === t && (t = {}), !(!t.ignoreErrors || !t.ignoreErrors.length) && this.jn(n)
					.some(function(n) {
				...
				return void 0 === n && (n = {}), {
					...
					ignoreErrors: s(this.in.ignoreErrors || [], n.ignoreErrors || [], yn),
				...
				if (n.exception) try {
					...
					return T.error("Cannot extract message for event " + x(n)), []
				}
				return []
				...
				try {
					...
					return T.error("Cannot extract url for event " + x(n)), null
				}
	...
	En._n = function() {
		...
		function c(t, r, e, c, s) {
			var f = null;
			if (s = l(s) ? s.error : s, t = l(t) ? t.message : t, i) En.On.Tn(i, r, e, t), a();
			else if (s && h(s))(f = En.On(s))
				.mechanism = "onerror", o(f, !0, s);
			else {
				var v, d = {
						url: r,
						line: e,
		...
		function s(n) {
			var t = n && (n.detail ? n.detail.reason : n.reason) || n,
				r = En.On(t);
			r.mechanism = "onunhandledrejection", r.message || (r.message = JSON.stringify(L(t))), o(r, !0, t)
		}
		...
		function n(n) {
			...
			for (var t, r, e, i = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|[a-z]:|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, o = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension).*?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js))(?::(\d+))?(?::(\d+))?\s*$/i, u = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, c = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, s = /\((\S*)(?::(\d+))(?::(\d+))\)/, a = n.stack.split("\n"), f = [], h = /^(.*) is undefined$/.exec(n.message), l = 0, v = a.length; l < v; ++l) {
				...
				}!e.func && e.line && (e.func = xn), e.context = null, f.push(e)
			}
		...
		function t(n, t, r, e) {
			...
			if (i.url && i.line) {
				if (n.incomplete = !1, i.func || (i.func = xn), i.context || (i.context = null), / '([^']+)' /.exec(e) && (i.column = null), n.stack.length > 0 && n.stack[0].url === i.url) {
					...
					if (t) {
						for (var r, e = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i, i = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\))? in (.*):\s*$/i, o = t.split("\n"), u = [], c = 0; c < o.length; c += 2) {
							...
							(r = e.exec(o[c])) ? s = {
								...
								func: r[3] || r[4],
								args: r[5] ? r[5].split(",") : []
							}), s && (!s.func && s.line && (s.func = xn), s.line && (s.context = null), s.context || (s.context = [o[c + 1]]), u.push(s))
						}
						return u.length ? {
							mode: "stacktrace",
							name: n.name,
				...
				if (i = function(n) {
					...
					for (var f = 2; f < t.length; f += 2) {
						...
						(r = e.exec(t[f])) ? h = {
							...
							line: r[1],
							column: null
						}), h && (h.func || (h.func = xn), h.context = [t[f + 1]], u.push(h))
					}
					return u.length ? {
						mode: "multiline",
						name: n.name,
	...
	var An, Ln, Mn = function() {
			function n(n) {
				this.options = n, this.h = new U(30), this.url = new an(this.options.dsn)
		...
		Fn = function(t) {
			...
			return r(e, t), e.prototype.sendEvent = function(t) {
				...
				return this.h.add(Un.fetch(this.url, r)
					.then(function(t) {
						return {
		...
		qn = function(t) {
			...
			return r(e, t), e.prototype.pn = function() {
				if (!this.in.dsn) return t.prototype.pn.call(this);
				var n = u({}, this.in.transportOptions, {
					dsn: this.in.dsn
				});
				return this.in.transport ? new this.in.transport(n) : H() ? new Fn(n) : new Pn(n)
			}, e.prototype.eventFromException = function(t, r) {
				var e, i, o = this;
				if (l(t) && t.error) return t = t.error, e = Cn(Rn(t)), B.resolve(this.Nn(e, r));
				if (v(t) || (i = t, "[object DOMException]" === Object.prototype.toString.call(i))) {
					...
					return this.eventFromMessage(s, n.Severity.Error, r)
						.then(function(n) {
							return _(n, s), B.resolve(o.Nn(n, r))
						})
				}
				if (h(t)) return e = Cn(Rn(t)), B.resolve(this.Nn(e, r));
				if (m(t) && r && r.syntheticException) return _(e = function(n, t) {
					var r = Object.keys(n)
						.sort(),
						e = {
							extra: {
							...
							message: "Non-Error exception captured with keys: " + $(r)
						};
					if (t) {
						var i = Nn(Rn(t)
							.stack);
					...
					synthetic: !0,
					type: "generic"
				}), e.level = n.Severity.Error, B.resolve(this.Nn(e, r));
				var a = t;
				return this.eventFromMessage(a, void 0, r)
					.then(function(t) {
						return _(t, "" + a, void 0, {
							handled: !0,
							synthetic: !0,
							type: "generic"
						}), t.level = n.Severity.Error, B.resolve(o.Nn(t, r))
					})
			}, e.prototype.Nn = function(n, t) {
				return u({}, n, {
				...
				if (this.in.attachStacktrace && e && e.syntheticException) {
					var o = Nn(Rn(e.syntheticException)
						.stack);
					i.stacktrace = {
						frames: o
					}
		...
		Wn = function(n) {
			...
			return r(t, n), t.prototype.hn = function(t, r, e) {
				return t.platform = t.platform || "javascript", t.sdk = u({}, t.sdk, {
					...
					version: "5.5.0"
				}), n.prototype.hn.call(this, t, r, e)
					...
					if (this.fn()) {
						...
						if (n.eventId)
							if (r) {
								...
								e.async = !0, e.src = new an(r)
									.getReportDialogEndpoint(n), n.onLoad && (e.onload = n.onLoad), (t.head || t.body)
									.appendChild(e)
	...
	function Xn(n, t, r) {
			...
			try {
				...
				throw Jn += 1, setTimeout(function() {
					...
					r.addEventProcessor(function(n) {
						var r = u({}, n);
						return t.mechanism && _(r, void 0, void 0, t.mechanism), r.extra = u({}, r.extra, {
							arguments: L(e, 3)
						}), r
					}), captureException(n)
				}), n
		...
		try {
			Object.getOwnPropertyDescriptor(sentryWrapped, "name")
				.configurable && Object.defineProperty(sentryWrapped, "name", {
					get: function() {
						return n.name
					}
				})
		...
		return void 0 === t && (t = !1),
			function(r) {
				if (An = void 0, r && Ln !== r) {
					...
					Gn && clearTimeout(Gn), t ? Gn = setTimeout(e) : e()
				}
			}
	}
	...
	function Vn() {
		return function(n) {
			...
			var r = t && t.tagName;
			r && ("INPUT" === r || "TEXTAREA" === r || t.isContentEditable) && (An || zn("input")(n), clearTimeout(An), An = setTimeout(function() {
				An = void 0
			}, Bn))
		}
	}
	...
	function Kn(n) {
		for (var t, r = n, e = [], i = 0, o = 0, u = " > ".length; r && i++ < 5 && !("html" === (t = Zn(r)) || i > 1 && o + e.length * u + t.length >= 80);) e.push(t), o += t.length, r = r.parentNode;
		return e.reverse()
			.join(" > ")
	}
	...
	var Qn = function() {
			...
			return n.prototype.setupOnce = function() {
				Error.stackTraceLimit = 50, On(function(t, r, e) {
					if (!(Jn > 0)) {
						var i = nn()
							.getIntegration(n);
						i && nn()
				...
				}), this.in.onerror && (T.log("Global Handler attached: onerror"), kn()), this.in.onunhandledrejection && (T.log("Global Handler attached: onunhandledrejection"), Tn())
			}, n.prototype.An = function(n) {
				if (!d(n.message) && "onunhandledrejection" !== n.mechanism) {
					var t = n.message;
					n.message = t.error && d(t.error.message) ? t.error.message : "No error message"
				}
				var r = Cn(n),
					e = {
						mode: n.mode
				...
				var i = nn()
					...
					o = i && i.getOptions()
					.maxValueLength || 250;
				return _(r, n.original ? F(JSON.stringify(L(n.original)), o) : "", "onunhandledrejection" === n.mechanism ? "UnhandledRejection" : "Error", {
					data: e,
					handled: !1,
					type: n.mechanism
				}), r
			...
			return n.prototype.Mn = function(n) {
				...
				r && r.hasOwnProperty && r.hasOwnProperty("addEventListener") && (D(r, "addEventListener", function(t) {
					return function(r, e, i) {
						try {
							"function" == typeof e.handleEvent && (e.handleEvent = Xn(e.handleEvent.bind(e), {
								mechanism: {
									data: {
				...
				this.Ln = this.Ln;
				var n = w();
				D(n, "setTimeout", this.Mn.bind(this)), D(n, "setInterval", this.Mn.bind(this)), D(n, "requestAnimationFrame", this.Un.bind(this)), ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"].forEach(this.Fn.bind(this))
			}, n.id = "TryCatch", n
		}();
	...
	var tt, rt = w(),
		et = function() {
			...
			return t.prototype.Pn = function() {
				"console" in rt && ["debug", "info", "warn", "error", "log", "assert"].forEach(function(r) {
					r in rt.console && D(rt.console, r, function(e) {
						return function() {
							...
							"assert" === r && !1 === i[0] && (u.message = "Assertion failed: " + (P(i.slice(1), " ") || "console.assert"), u.data.extra.arguments = L(i.slice(1), 3)), t.addBreadcrumb(u, {
								input: i,
								level: r
				...
				"document" in rt && (rt.document.addEventListener("click", zn("click"), !1), rt.document.addEventListener("keypress", Vn(), !1), ["EventTarget", "Node"].forEach(function(n) {
					...
					t && t.hasOwnProperty && t.hasOwnProperty("addEventListener") && (D(t, "addEventListener", function(n) {
						return function(t, r, e) {
							return r && r.handleEvent ? ("click" === t && D(r, "handleEvent", function(n) {
								return function(t) {
									return zn("click")(t), n.call(this, t)
								}
							}), "keypress" === t && D(r, "handleEvent", function(n) {
								return function(t) {
									return Vn()(t), n.call(this, t)
								}
							})) : ("click" === t && zn("click", !0)(this), "keypress" === t && Vn()(this)), n.call(this, t, r, e)
						}
				...
				(function() {
					...
					return function() {
						...
						var o, u = e[0],
							c = "GET";
						"string" == typeof u ? o = u : "Request" in rt && u instanceof Request ? (o = u.url, u.method && (c = u.method)) : o = String(u), e[1] && e[1].method && (c = e[1].method);
						var s = nn()
							.getClient(),
							a = s && s.getDsn();
						if (a) {
				...
				var n = this;
				if (r = w(), e = r.chrome, i = e && e.app && e.app.runtime, o = "history" in r && !!r.history.pushState && !!r.history.replaceState, !i && o) {
					var r, e, i, o, u = function(n, r) {
							var e = E(rt.location.href),
								i = E(r),
								o = E(n);
							o.path || (o = e), tt = r, e.protocol === i.protocol && e.host === i.host && (r = i.relative), e.protocol === o.protocol && e.host === o.host && (n = o.relative), t.addBreadcrumb({
								category: "navigation",
								data: {
									from: n,
									to: r
					...
					}, D(rt.history, "pushState", s), D(rt.history, "replaceState", s)
				}
				...
				this.in.console && this.Pn(), this.in.dom && this.$n(), this.in.xhr && this.Wn(), this.in.fetch && this.qn(), this.in.history && this.Hn()
			}, t.id = "Breadcrumbs", t
		}();
	...
	var ot = "cause",
		...
		ct = function() {
			function n(t) {
				void 0 === t && (t = {}), this.name = n.id, this.Bn = t.key || ot, this.s = t.limit || ut
			}
			return n.prototype.setupOnce = function() {
				V(function(t, r) {
					var e = nn()
			...
			return n.prototype.setupOnce = function() {
				V(function(t) {
					if (nn()
						...
						var r = t.request || {};
						return r.url = r.url || st.location.href, r.headers = r.headers || {}, r.headers["User-Agent"] = st.navigator.userAgent, u({}, t, {
							request: r
						})
					}
					return t
	...
	var dt = u({}, lt, wn, ft);
	return n.BrowserClient = Wn, n.Hub = Z, n.Integrations = dt, n.SDK_NAME = Hn, n.SDK_VERSION = "5.5.0", n.Scope = G, n.Span = X, n.Transports = $n, n.addBreadcrumb = function(n) {
		on("addBreadcrumb", n)
	}, n.addGlobalEventProcessor = V, n.captureEvent = function(n) {
		...
		on("configureScope", n)
	}, n.defaultIntegrations = ht, n.flush = function(n) {
		var t = nn()
			.getClient();
		return t ? t.flush(n) : Promise.reject(!1)
	}, n.forceLoad = function() {}, n.getCurrentHub = nn, n.getHubFromCarrier = rn, n.init = function(n) {
		...
		void 0 === n && (n = {}), n.eventId || (n.eventId = nn()
			.lastEventId());
		var t = nn()
			.getClient();
		t && t.showReportDialog(n)
	}, n.withScope = un, n.wrap = function(n) {
		Xn(n)()
	}, n
}({});
