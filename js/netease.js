...
(function (u) {
        ...
        r = r.MD5 = v.extend({
            mi0x: function () {
                this.cT8L = new w.init([1732584193, 4023233417, 2562383102, 271733878])
            },
            sI2x: function (q, n) {
                for (var a = 0; 16 > a; a++) {
                    var c = n + a
...
function asrseaDict(musicId, csrf_token) {
    d = {"ids": musicId, "level": "standard", "encodeType": "aac", "csrf_token": csrf_token},
        e = "010001",
...
function asrseaDict2(musicId) {
    d = {"ids": musicId, "level": "standard", "encodeType": "aac", "csrf_token": "0184df3f4bb5f9bec3c84ab0e4baa157"},
        e = "010001",
        f = "",
        g = "0CoJUm6Qyw8W8jud"
    return asrsea(JSON.stringify(d), e, f, g)
...
console.log(asrseaDict2(2132193789));
